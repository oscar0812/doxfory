...
abstract class Comment implements ActiveRecordInterface
{
    ...
    public function setTimestamp($v)
    {
        ...
        if ($this->timestamp !== $v) {
            $this->timestamp = $v;
            $this->modifiedColumns[CommentTableMap::COL_TIMESTAMP] = true;
        }
    ...
    public function setJobId($v)
    {
        ...
        if ($this->job_id !== $v) {
            $this->job_id = $v;
            $this->modifiedColumns[CommentTableMap::COL_JOB_ID] = true;
        }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CommentTableMap::COL_TIMESTAMP)) {
            $modifiedColumns[':p' . $index++]  = 'timestamp';
        }
        if ($this->isColumnModified(CommentTableMap::COL_USER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'user_id';
        }
        if ($this->isColumnModified(CommentTableMap::COL_JOB_ID)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommentTableMap::COL_TIMESTAMP)) {
            $criteria->add(CommentTableMap::COL_TIMESTAMP, $this->timestamp);
        }
        if ($this->isColumnModified(CommentTableMap::COL_USER_ID)) {
            $criteria->add(CommentTableMap::COL_USER_ID, $this->user_id);
        }
        if ($this->isColumnModified(CommentTableMap::COL_JOB_ID)) {
            $criteria->add(CommentTableMap::COL_JOB_ID, $this->job_id);
        }
